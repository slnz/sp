class Admin::PeopleController < ApplicationController
  ...
  def person_params
    params.fetch(:person, {}).permit(:start_date, :end_date, :first_name, :last_name, :preferredName, current_address_attributes: [:home_phone, :cell_phone, :work_phone, :email, :address1, :address2, :city, :state, :zip, :country, :id]) # :current_application
  end
end
