...
ActiveRecord::Schema.define(version: 20140519153608) do
  ...
  add_index "access_grants", ["code"], name: "index_access_grants_on_code", unique: true, using: :btree
  ...
  add_index "access_tokens", ["code"], name: "index_access_tokens_on_code", unique: true, using: :btree
  add_index "access_tokens", ["identity"], name: "index_access_tokens_on_identity", using: :btree
  ...
  add_index "activities", ["target_area_id", "organization_id"], name: "index_activities_on_target_area_id_and_organization_id", unique: true, using: :btree
  ...
  add_index "auth_requests", ["client_id"], name: "index_auth_requests_on_client_id", using: :btree
  add_index "auth_requests", ["code"], name: "index_auth_requests_on_code", using: :btree
  ...
  add_index "clients", ["display_name"], name: "index_clients_on_display_name", unique: true, using: :btree
  add_index "clients", ["link"], name: "index_clients_on_link", unique: true, using: :btree
  ...
  add_index "contact_assignments", ["assigned_to_id", "organization_id"], name: "index_contact_assignments_on_assigned_to_id_and_organization_id", using: :btree
  add_index "contact_assignments", ["organization_id"], name: "index_contact_assignments_on_organization_id", using: :btree
  add_index "contact_assignments", ["person_id", "organization_id"], name: "index_contact_assignments_on_person_id_and_organization_id", unique: true, using: :btree
  ...
  add_index "followup_comments", ["organization_id", "contact_id"], name: "comment_organization_id_contact_id", using: :btree
  ...
  add_index "hr_si_payment", ["fk_ApplicationID"], name: "fk_ApplicationID", using: :btree
  ...
  add_index "hr_si_reference", ["fk_SIApplicationID"], name: "fk_SIApplicationID", using: :btree
  add_index "hr_si_reference", ["oldReferenceID"], name: "oldReferenceID", using: :btree
  add_index "hr_si_reference", ["oldSIApplicationID"], name: "IX_hr_si_Reference_2006", using: :btree
  add_index "hr_si_reference", ["siYear"], name: "siYear", using: :btree
  ...
  add_index "mh_answers", ["answer_sheet_id"], name: "index_ma_answers_on_answer_sheet_id", using: :btree
  add_index "mh_answers", ["question_id"], name: "index_ma_answers_on_question_id", using: :btree
  add_index "mh_answers", ["short_value"], name: "index_ma_answers_on_short_value", using: :btree
  ...
  add_index "mh_elements", ["conditional_id"], name: "index_ma_elements_on_conditional_id", using: :btree
  add_index "mh_elements", ["position"], name: "index_ma_elements_on_question_sheet_id_and_position_and_page_id", using: :btree
  add_index "mh_elements", ["question_grid_id"], name: "index_ma_elements_on_question_grid_id", using: :btree
  add_index "mh_elements", ["slug"], name: "index_ma_elements_on_slug", using: :btree
  ...
  add_index "mh_email_templates", ["name"], name: "index_ma_email_templates_on_name", length: {"name"=>255}, using: :btree
  ...
  add_index "mh_friends", ["person_id", "uid"], name: "person_uid", unique: true, using: :btree
  ...
  add_index "mh_group_labelings", ["group_id", "group_label_id"], name: "index_mh_group_labelings_on_group_id_and_group_label_id", unique: true, using: :btree
  add_index "mh_group_labelings", ["group_label_id"], name: "index_mh_group_labelings_on_group_label_id", using: :btree
  ...
  add_index "mh_group_labels", ["organization_id"], name: "index_mh_group_labels_on_organization_id", using: :btree
  ...
  add_index "mh_group_memberships", ["group_id"], name: "index_group_memberships_on_group_id", using: :btree
  add_index "mh_group_memberships", ["person_id"], name: "index_group_memberships_on_person_id", using: :btree
  ...
  add_index "mh_imports", ["user_id", "organization_id"], name: "user_org", using: :btree
  ...
  add_index "mh_question_sheets", ["questionnable_id", "questionnable_type"], name: "questionnable", using: :btree
  ...
  add_index "organization_memberships", ["organization_id", "person_id"], name: "index_organization_memberships_on_organization_id_and_person_id", unique: true, using: :btree
  add_index "organization_memberships", ["person_id"], name: "person_id", using: :btree
  ...
  add_index "organizational_roles", ["organization_id", "role_id", "followup_status"], name: "role_org_status", using: :btree
  add_index "organizational_roles", ["person_id", "organization_id", "role_id"], name: "person_role_org", unique: true, using: :btree
  ...
  add_index "organizations", ["importable_type", "importable_id"], name: "index_organizations_on_importable_type_and_importable_id", unique: true, using: :btree
  ...
  add_index "received_sms", ["person_id"], name: "person_id", using: :btree
  add_index "received_sms", ["phone_number", "message", "received_at"], name: "index_received_sms_on_phone_number_and_message_and_received_at", unique: true, using: :btree
  add_index "received_sms", ["twilio_sid"], name: "index_received_sms_on_twilio_sid", unique: true, using: :btree
  ...
  add_index "saved_contact_searches", ["user_id"], name: "index_saved_contact_searches_on_user_id", using: :btree
  ...
  add_index "sent_sms", ["twilio_sid"], name: "index_sent_sms_on_twilio_sid", unique: true, using: :btree
  ...
  add_index "si_apply_sheets", ["apply_id"], name: "apply_id", using: :btree
  ...
  add_index "si_sleeves", ["slug"], name: "index_si_sleeves_on_slug", unique: true, using: :btree
  ...
  add_index "sms_keywords", ["organization_id"], name: "organization_id", using: :btree
  add_index "sms_keywords", ["survey_id"], name: "index_sms_keywords_on_survey_id", using: :btree
  add_index "sms_keywords", ["user_id"], name: "user_id", using: :btree
  ...
  add_index "sms_sessions", ["phone_number", "updated_at"], name: "session", using: :btree
  ...
  add_index "sn_campus_involvements", ["campus_id"], name: "index_sn_campus_involvements_on_campus_id", using: :btree
  add_index "sn_campus_involvements", ["ministry_id"], name: "index_sn_campus_involvements_on_ministry_id", using: :btree
  add_index "sn_campus_involvements", ["person_id"], name: "index_sn_campus_involvements_on_person_id", using: :btree
  ...
  add_index "sn_correspondences", ["receipt"], name: "index_sn_correspondences_on_receipt", using: :btree
  ...
  add_index "sn_custom_attributes", ["ministry_id"], name: "index_sn_custom_attributes_on_ministry_id", using: :btree
  add_index "sn_custom_attributes", ["type"], name: "index_sn_custom_attributes_on_type", using: :btree
  ...
  add_index "sn_custom_values", ["person_id", "custom_attribute_id"], name: "index_sn_custom_values_on_person_id_and_custom_attribute_id", unique: true, using: :btree
  ...
  add_index "sn_dorms", ["campus_id"], name: "campus_id", using: :btree
  ...
  add_index "sn_group_involvements", ["person_id", "group_id"], name: "person_group", unique: true, using: :btree
  ...
  add_index "sn_groups", ["campus_id"], name: "index_sn_groups_on_campus_id", using: :btree
  add_index "sn_groups", ["dorm_id"], name: "index_sn_groups_on_dorm_id", using: :btree
  add_index "sn_groups", ["ministry_id"], name: "index_sn_groups_on_ministry_id", using: :btree
  add_index "sn_groups", ["semester_id"], name: "index_sn_groups_on_semester_id", using: :btree
  ...
  add_index "sn_ministries", ["lft"], name: "index_sn_ministries_on_lft", using: :btree
  add_index "sn_ministries", ["parent_id"], name: "index_sn_ministries_on_parent_id", using: :btree
  add_index "sn_ministries", ["rgt"], name: "index_sn_ministries_on_rgt", using: :btree
  ...
  add_index "sn_ministry_campuses", ["ministry_id", "campus_id"], name: "ministry_campus", unique: true, using: :btree
  ...
  add_index "sn_ministry_involvements", ["ministry_id"], name: "index_sn_ministry_involvements_on_ministry_id", using: :btree
  add_index "sn_ministry_involvements", ["person_id", "ministry_id"], name: "person_ministry", unique: true, using: :btree
  ...
  add_index "sn_ministry_roles", ["ministry_id"], name: "index_sn_ministry_roles_on_ministry_id", using: :btree
  ...
  add_index "sn_person_news", ["news_id"], name: "index_sn_person_news_on_news_id", using: :btree
  add_index "sn_person_news", ["person_id"], name: "index_sn_person_news_on_person_id", using: :btree
  ...
  add_index "sn_semesters", ["start_date"], name: "index_sn_semesters_on_start_date", using: :btree
  add_index "sn_semesters", ["year_id"], name: "index_sn_semesters_on_year_id", using: :btree
  ...
  add_index "sn_sessions", ["session_id"], name: "index_sessions_on_session_id", using: :btree
  add_index "sn_sessions", ["updated_at"], name: "index_sessions_on_updated_at", using: :btree
  ...
  add_index "sn_timetables", ["person_id"], name: "person_id", using: :btree
  ...
  add_index "sn_training_answers", ["person_id"], name: "index_sn_training_answers_on_person_id", using: :btree
  ...
  add_index "sn_training_categories", ["ministry_id"], name: "index_sn_training_categories_on_ministry_id", using: :btree
  ...
  add_index "sn_training_questions", ["ministry_id"], name: "index_sn_training_questions_on_ministry_id", using: :btree
  add_index "sn_training_questions", ["training_category_id"], name: "index_sn_training_questions_on_training_category_id", using: :btree
  ...
  add_index "sn_user_codes", ["user_id"], name: "index_sn_user_codes_on_user_id", using: :btree
  ...
  add_index "sn_view_columns", ["column_id"], name: "index_sn_view_columns_on_column_id", using: :btree
  add_index "sn_view_columns", ["view_id", "column_id"], name: "index_sn_view_columns_on_view_id_and_column_id", using: :btree
  ...
  add_index "sn_views", ["ministry_id"], name: "index_sn_views_on_ministry_id", using: :btree
  ...
  create_table "sp_project_ministry_focuses", id: false, force: true do |t|
