...
ActiveRecord::Schema.define(version: 20140820015151) do
  ...
  create_table "crs_conference", primary_key: "conferenceID", force: true do |t|
    ...
    t.float    "onsiteCost",               limit: 53
    t.float    "commuterCost",             limit: 53
    t.float    "preRegDeposit",            limit: 53
    t.float    "discountFullPayment",      limit: 53
    t.float    "discountEarlyReg",         limit: 53
  ...
  create_table "crs_registrationtype", primary_key: "registrationTypeID", force: true do |t|
    ...
    t.datetime "preRegStart"
    t.datetime "preRegEnd"
    t.float    "singlePreRegDeposit",         limit: 53
    t.float    "singleOnsiteCost",            limit: 53
    t.float    "singleCommuteCost",           limit: 53
    t.float    "singleDiscountFullPayment",   limit: 53
    t.float    "singleDiscountEarlyReg",      limit: 53
    t.datetime "singleDiscountEarlyRegDate"
    t.float    "marriedPreRegDeposit",        limit: 53
    t.float    "marriedOnsiteCost",           limit: 53
    t.float    "marriedCommuteCost",          limit: 53
    t.float    "marriedDiscountFullPayment",  limit: 53
    t.float    "marriedDiscountEarlyReg",     limit: 53
  ...
  create_table "hr_si_applications", force: true do |t|
  ...
  add_index "hr_si_applications", ["applicant_id"], name: "fk_PersonID", using: :btree
  ...
  add_index "hr_si_applications", ["si_year"], name: "siYear", using: :btree
  ...
  create_table "mpd_expense_types", force: true do |t|
    ...
    t.float  "default_amount", limit: 24, default: 0.0
  end
  ...
  create_table "old_wsn_sp_wsnapplication", primary_key: "WsnApplicationID", force: true do |t|
    ...
    t.float    "supportBalance",                limit: 24
  ...
  create_table "si_applies_deprecated", force: true do |t|
    t.integer  "sleeve_id"
    t.integer  "applicant_id",            null: false
  ...
  add_index "si_applies_deprecated", ["applicant_id"], name: "applicant_id", using: :btree
  add_index "si_applies_deprecated", ["sleeve_id"], name: "sleeve_id", using: :btree
  add_index "si_applies_deprecated", ["status"], name: "index_si_applies_deprecated_on_status", using: :btree
  add_index "si_applies_deprecated", ["submitted_at"], name: "index_si_applies_deprecated_on_submitted_at", using: :btree
  ...
  add_index "si_elements", ["position", "page_id"], name: "index_si_elements_on_question_sheet_id_and_position_and_page_id", using: :btree
