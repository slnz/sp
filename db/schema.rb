...
ActiveRecord::Schema.define(:version => 20100906162449) do
  ...
  create_table "sp_answers_depreated", :force => true do |t|
    t.integer "question_id"
  ...
  add_index "sp_answers_depreated", ["instance_id", "question_id"], :name => "question_id", :unique => true
  add_index "sp_answers_depreated", ["question_id"], :name => "question_id_only"
